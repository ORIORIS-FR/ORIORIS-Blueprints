...
Intégration Agentique : Inspiré de n8n-nodes-langchain.

State Machines : Utilisation de LangGraph pour l'agent d'audit.

Orchestration Multi-Agents : Routage via CrewAI connecté en natif à LiteLLM.
